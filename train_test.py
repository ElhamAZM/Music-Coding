...
class Runner(object):
    def __init__(self, hparams):
        ...
        self.optimizer = torch.optim.Adam(self.model.parameters(), lr=hparams.learning_rate, betas=(0.9, 0.999), eps=1e-8,weight_decay=0.02, amsgrad=True,) #use the Adam optimizer 
